...
<?php } ?>
                    ...
                    <td class="text-center align-middle">
                      ...
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a href="{{ url('card/' . \App\Http\Controllers\Core\Secure::staticHash($card->id)) }}" class="btn btn-sm btn-info rounded-0" target="_blank" data-toggle="tooltip" title="{{ trans('nearby-platform.view') }}"><i class="mi search"></i></a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content rounded-0 mdl-shadow--8dp border border-white">
            ...
            <div class="modal-body">
              <img src="<?php echo \Cache::rememberForever('qr-'.md5($card->getUrl()), function () use ($card) {
                  return DNS2D::getBarcodePNGPath($card->getUrl(), 'QRCODE', 10, 10, [0, 0, 0]);
