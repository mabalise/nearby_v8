...
<?php } ?>
                    ...
                    <td class="text-center align-middle">
                      ...
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a href="{{ url('deal/' . \App\Http\Controllers\Core\Secure::staticHash($deal->id)) }}" class="btn btn-sm btn-info rounded-0 mr-2" target="_blank" data-toggle="tooltip" title="{{ trans('nearby-platform.view') }}"><i class="mi search"></i></a>

                        <script src="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.5.13/clipboard.min.js"></script>
                        <script type='text/javascript'>
                         var clipboard = new Clipboard('.btn');
                        </script>
                        <button class="btn btn-sm btn-info rounded-0 mr-2" data-toggle="tooltip" title="{{ trans('nearby-platform.copy_to_clipboard') }}" data-clipboard-text="{{ url('deal/' . \App\Http\Controllers\Core\Secure::staticHash($deal->id)) }}"><i class="fas fa-external-link-alt"></i></button> 
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content rounded-0 mdl-shadow--8dp border border-white">
            ...
            <div class="modal-body">
              <img src="<?php echo \Cache::rememberForever('qr-' . md5($deal->getUrl()), function() use($deal) { return DNS2D::getBarcodePNGPath($deal->getUrl(), 'QRCODE', 10, 10, [0,0,0]); }); ?>" alt="barcode" style="width:100%;">
