...
tinymce.init({
  ...
  forced_root_block: '',
  plugins: 'advlist autolink link image paste table media lists charmap colorpicker textcolor code contextmenu placeholder autoresize',
  toolbar: 'fontsizeselect | bold italic link | bullist numlist<?php /* outdent indent*/ ?> | forecolor backcolor',
  contextmenu: 'paste | link image | link image inserttable | cell row column deletetable',
  paste_as_text: true,
