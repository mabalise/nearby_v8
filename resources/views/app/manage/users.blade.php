...
?>
                  <tr<?php if (! $user->active) echo ' class="table-danger"'; ?></tr>
                    ...
                    <td class="align-middle text-center">{{ $user->deals->count() }} / {{ $user->deals_limit }}</td>
                    <td class="align-middle text-center">{{ $user->coupons->count() }} / {{ $user->coupons_limit }}</td>
                    <td class="align-middle text-center">{{ $user->rewards->count() }} / {{ $user->rewards_limit }}</td>
                    <td class="align-middle text-center">{{ $user->properties->count() }} / {{ $user->properties_limit }}</td>
                    <td class="align-middle text-center">{{ $user->businessCards->count() }} / {{ $user->business_cards_limit }}</td>
                    <td class="align-middle text-center">{{ $user->videos->count() }} / {{ $user->videos_limit }}</td>
                    <td class="align-middle text-center">{{ $user->pages->count() }} / {{ $user->pages_limit }}</td>
