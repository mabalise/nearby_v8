...
?>
                      ...
                      <div class="card rounded-0 border-secondary mb-4">
                        ...
                        <div class="card-body">
                          ...
                          <!-- Element du formulaire pour la limite de pages -->
                          <div class="form-group row">
                              <label for="limit" class="col-12 col-sm-4 col-form-label">{{ trans('nearby-platform.pages_limit') }} <sup>*</sup></label>
                              <div class="col-12 col-sm-8">
                                <div class="input-group input-group-lg">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text rounded-0"><i class="fa fa-file"></i></span>
                                  </div>
                                  <!-- Si $sl est existant, c'est-à-dire que le user existe et a une id -->
                                  <?php if (isset($sl)) { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="pages_limit" value={{$user->pages_limit}} min="0" max="1000" required>
                                  <!-- Si l'utilisateur n'existe pas -->
                                  <?php } else { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="pages_limit" value="3" min="0" max="1000" required>
                                  <?php } ?>
                                </div>
                              </div>
                          </div>

                          <!-- Element du formulaire pour la limite de deals -->
                          <div class="form-group row">
                              <label for="limit" class="col-12 col-sm-4 col-form-label">{{ trans('nearby-platform.deals_limit') }} <sup>*</sup></label>
                              <div class="col-12 col-sm-8">
                                <div class="input-group input-group-lg">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text rounded-0"><i class="fas fa-store-alt"></i></span>
                                  </div>
                                  <!-- Si $sl est existant, c'est-à-dire que le user existe et a une id -->
                                  <?php if (isset($sl)) { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="deals_limit" value={{$user->deals_limit}} min="0" max="1000" required>
                                  <!-- Si l'utilisateur n'existe pas -->
                                  <?php } else { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="deals_limit" value="3" min="0" max="1000" required>
                                  <?php } ?>
                                </div>
                              </div>
                          </div>

                          <!-- Element du formulaire pour la limite de coupons -->
                          <div class="form-group row">
                              <label for="limit" class="col-12 col-sm-4 col-form-label">{{ trans('nearby-platform.coupons_limit') }} <sup>*</sup></label>
                              <div class="col-12 col-sm-8">
                                <div class="input-group input-group-lg">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text rounded-0"><i class="fas fa-gift"></i></span>
                                  </div>
                                  <!-- Si $sl est existant, c'est-à-dire que le user existe et a une id -->
                                  <?php if (isset($sl)) { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="coupons_limit" value={{$user->coupons_limit}} min="0" max="1000" required>
                                  <!-- Si l'utilisateur n'existe pas -->
                                  <?php } else { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="coupons_limit" value="3" min="0" max="1000" required>
                                  <?php } ?>
                                </div>
                              </div>
                          </div>

                          <!-- Element du formulaire pour la limite de rewards -->
                          <div class="form-group row">
                              <label for="limit" class="col-12 col-sm-4 col-form-label">{{ trans('nearby-platform.rewards_limit') }} <sup>*</sup></label>
                              <div class="col-12 col-sm-8">
                                <div class="input-group input-group-lg">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text rounded-0"><i class="fa fa-check"></i></span>
                                  </div>
                                  <!-- Si $sl est existant, c'est-à-dire que le user existe et a une id -->
                                  <?php if (isset($sl)) { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="rewards_limit" value={{$user->rewards_limit}} min="0" max="1000" required>
                                  <!-- Si l'utilisateur n'existe pas -->
                                  <?php } else { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="rewards_limit" value="3" min="0" max="1000" required>
                                  <?php } ?>
                                </div>
                              </div>
                          </div>

                          <!-- Element du formulaire pour la limite de properties -->
                          <div class="form-group row">
                              <label for="limit" class="col-12 col-sm-4 col-form-label">{{ trans('nearby-platform.properties_limit') }} <sup>*</sup></label>
                              <div class="col-12 col-sm-8">
                                <div class="input-group input-group-lg">
                                  <div class="input-group-prepend">
                                  ...
                                  <!-- Si $sl est existant, c'est-à-dire que le user existe et a une id -->
                                  <?php if (isset($sl)) { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="properties_limit" value={{$user->properties_limit}} min="0" max="1000" required>
                                  <!-- Si l'utilisateur n'existe pas -->
                                  <?php } else { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="properties_limit" value="3" min="0" max="1000" required>
                                  <?php } ?>
                                </div>
                              </div>
                          </div>

                          <!-- Element du formulaire pour la limite de business cards -->
                          <div class="form-group row">
                              <label for="limit" class="col-12 col-sm-4 col-form-label">{{ trans('nearby-platform.business_cards_limit') }} <sup>*</sup></label>
                              <div class="col-12 col-sm-8">
                                <div class="input-group input-group-lg">
                                  <div class="input-group-prepend">
                                  ...
                                  <!-- Si $sl est existant, c'est-à-dire que le user existe et a une id -->
                                  <?php if (isset($sl)) { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="business_cards_limit" value={{$user->business_cards_limit}} min="0" max="1000" required>
                                  <!-- Si l'utilisateur n'existe pas -->
                                  <?php } else { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="business_cards_limit" value="3" min="0" max="1000" required>
                                  <?php } ?>
                                </div>
                              </div>
                          </div>

                          <!-- Element du formulaire pour la limite de videos -->
                          <div class="form-group row">
                              <label for="limit" class="col-12 col-sm-4 col-form-label">{{ trans('nearby-platform.videos_limit') }} <sup>*</sup></label>
                              <div class="col-12 col-sm-8">
                                <div class="input-group input-group-lg">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text rounded-0"><i class="fab fa-youtube"></i></span>
                                  </div>
                                  <!-- Si $sl est existant, c'est-à-dire que le user existe et a une id -->
                                  <?php if (isset($sl)) { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="videos_limit" value={{$user->videos_limit}} min="0" max="1000" required>
                                  <!-- Si l'utilisateur n'existe pas -->
                                  <?php } else { ?>
                                    <input id="limit" type="number" class="form-control rounded-0 form-control-lg" name="videos_limit" value="3" min="0" max="1000" required>
                                  <?php } ?>
                                </div>
                              </div>
                          </div>
