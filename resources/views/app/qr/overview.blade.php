...
foreach ($qr_codes as $qr_code) {
  ...
  $metrics = \DB::table('metrics')->select(['count as views', 'data->fired_at as dates'])->where('type', \App\Metrics\QrViewCountMetrics::class)->where('metricable_id', $qr_code->id)->first();
              ...
              <div class="card-footer">
                ...
                <div class="float-right">
                  ...
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.5.13/clipboard.min.js"></script>
                        ...
                        <button class="btn btn-sm btn-info rounded-0 mr-2" data-toggle="tooltip" title="{{ trans('nearby-platform.copy_to_clipboard') }}" data-clipboard-text="{{ url('qr/' . \App\Http\Controllers\Core\Secure::staticHash($qr_code->id)) }}"><i class="fas fa-external-link-alt"></i></button> 
