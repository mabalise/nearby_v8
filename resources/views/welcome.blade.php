                ...
                <div class="row">
                  <div class="col-12 col-lg-6 text-md-center text-lg-left">
                    <div class="mt-5 mt-md-4 mt-lg-5 pt-5 pt-md-2">
                      <div class="row">
                        <h1 class="display-4 color-light mt-lg-5 mt-5 col-12 col-lg-11">{{ trans('website.page_title') }} <small>{{ trans('website.with') }} </small>{{ trans('website.nearby_platform') }} </h1>
                      </div>
                      <p class="lead mb-5">{{ trans('website.page_desc') }}</p>

                    </div>
                    <div class="btn-container btn-stack-md">
                      <a class="btn btn-light btn-xlg rounded-0 ml-0" href="{{ url(trans('website.page_prefix') . 'login') }}" role="button">{!! trans('website.cm_cta') !!}</a>
                      <a class="btn btn-outline-light btn-xlg rounded-0" href="#about" role="button">{{ trans('nearby-platform.about') }}</a>
                    </div>
                  </div>
